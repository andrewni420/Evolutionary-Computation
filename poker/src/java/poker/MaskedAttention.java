...
public final class MaskedAttention extends AbstractBlock {
    ...
    private MaskedAttention(Builder builder) {
        super(VERSION);
    ...
    protected NDList forwardInternal(
        ...
        if (attentionMask != null) {
            ...
            if (attentionMask.getShape().dimension() != 4) {
                ...
                // 0s into a value of -10000. Adding this to the scores will push all unwanted
    ...
    /** A builder for {@link MaskedAttention}s. */
    public static final class Builder {
        ...
        public MaskedAttention build() {
            ...
            return new MaskedAttention(this);
        }
    }
}
