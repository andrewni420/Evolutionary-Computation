...
import poker.SparseMax;

/**
 * A Block implementing sparse softmaxed attention
 * Adapted from ai.djl.nn.transformer.ScaledDotProductAttention to support topK softmax
 *
...
public final class SparseAttentionBlock extends AbstractBlock {
    ...
    private SparseAttentionBlock(Builder builder) {
        super(VERSION);
        ...
        this.sparseMax = new SparseMax(-1,builder.topK);
    }
    ...
    protected NDList forwardInternal(
        ...
        /********** Sparse Attention ***********/  
        NDArray attentionProbs = sparseMax.forward(parameterStore, 
                                                new NDList(normalizedAttentionScores), 
                                                training,
                                                params)
                                            .singletonOrThrow();
        /***************************************/  
    ...
    /** A builder for {@link SparseAttentionBlock}s. */
    public static final class Builder {
        ...
        /**
         * Creates a new {@code SparseAttentionBlock} with the current configuration.
         *
         * @return a new {@code SparseAttentionBlock} with the current configuration.
         */
        public SparseAttentionBlock build() {
            if (embeddingSize < 1) {
            ...
            if (topK<2){
                throw new IllegalStateException("Top K must be 2 or more");
            }
            return new SparseAttentionBlock(this);
        }
    }
}